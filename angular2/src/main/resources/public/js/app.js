...
var exampleApp = angular.module('exampleApp', [ 'ngRoute', 'ngCookies',
		'exampleApp.services' ]);
...
exampleApp.run(function($rootScope, $http, $location, $cookieStore,
		LoginService) {
...
function LoginController($scope, $rootScope, $location, $http, $cookieStore,
		LoginService) {
...
services.factory('NewsService', function($resource) {
	return $resource('http://localhost:8080/news/:id', {
		id : '@id'
	});
});
